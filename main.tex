...
\bibitem{zheng2025}
Y.~Zheng, T.~Yu, Y.~Yang, Y.~Hu, X.~Lai, D.~Williams, and A.~Quinn.
\newblock Extending applications safely and efficiently.
\newblock In \emph{19th USENIX Symposium on Operating Systems Design and
  Implementation (OSDI 25)}, pages 557--574, 2025.
