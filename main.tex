...
Table~\ref{tab:tool_comparison} describes denet's capabilities as compared to other profilers and Unix tools.


\begin{table}[ht]
  \centering
  \footnotesize
  \caption{Comparison of process monitoring tools and libraries. Adapt. sampling: adaptive sampling. Struct. output: structured output.}
  \label{tab:tool_comparison}
%  \begin{tabularx}{\linewidth}{@{} L L *{6}{C} @{}}
  \begin{tabularx}{\linewidth}{@{} L L *{5}{C} @{}}
   \toprule
    Tool                    & Output              & \thead{Process tree}  & API/CLI & \thead{Adapt. sampling} & \thead{Struct. output} & Extensibility     \\
    \midrule
    ...
    \texttt{psutil\cite{rodola2020psutil}/psrecord\cite{psrecord}}& Text/PNG  & Partial      & Both     & No          & Limited      & Python            \\
