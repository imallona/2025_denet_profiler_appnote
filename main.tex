...
\hline
\textbf{Tool} & \textbf{Output} & \textbf{Process Tree} & \textbf{API/CLI} & \textbf{Adaptive Sampling} & \textbf{Child Process Tracking} & \textbf{Structured Output} & \textbf{Extensibility} \\
\hline
\texttt{denet} & Terminal, JSON, CSV & Yes & Both & Yes & Yes & Yes & Python, Rust \\
\texttt{top/htop} & Terminal & Partial & CLI & No & No & No & No \\
\texttt{ps} & Text/CSV & No & CLI & No & No & No & No \\
\texttt{time} & Text & No & CLI & No & No & No & No \\
\texttt{pidstat} & CSV/Text & Partial & CLI & No & With options & Limited & No \\
\texttt{psutil (Python)} & {\color{red}?} & Partial & API & No & Via scripting & Programmatic & Python \\
\texttt{psrecord} & \textit{todo} & \textit{todo} & \textit{todo} & \textit{todo} & \textit{todo} & \textit{todo} & \textit{todo} \\
\hline
\end{tabular}
